import { Controller, Post, UseGuards, ParseIntPipe, Query } from '@nestjs/common';
...
export class AccountController {
  ...
  @Post('admin-account')
  public createAdminAccount(@GetUser('id') userId: number, @Query('year') year: string) {
    return this.accountService.createAdminAccount(userId, year);
  }

  @Post('public-account')
  public createPublicAccount(@GetUser('id') userId: number, @Query('year') year: string) {
